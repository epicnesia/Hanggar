package id.jagr.mod.hanggar.emojis;

import id.jagr.mod.hanggar.emojis.EmojiManager.isEmoji
import id.jagr.mod.hanggar.emojis.EmojiParser.FitzpatrickAction.*
import id.jagr.mod.hanggar.emojis.EmojiParser.extractEmojiStrings
import java.util.*
