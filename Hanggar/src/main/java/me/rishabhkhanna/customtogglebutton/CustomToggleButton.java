...
public class CustomToggleButton extends androidx.appcompat.widget.AppCompatToggleButton {
    ...
    public void initialize(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.custom_toggle, null, false);
    }
...
//        getting all the attributes values set from the typed array i.e from user
        ...
        float radius = typedArray.getDimension(R.styleable.CustomToggleButton_customToggleButtonRadius, 15.0f);
